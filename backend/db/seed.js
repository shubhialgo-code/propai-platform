...
async function main() {
  ...
  const properties = [
    ...
    {
      title: "Scenic Villa in Tellapur",
      description: "A beautiful villa with scenic views in Tellapur. Offers a serene environment away from the city noise but close to major IT hubs.",
      price: 150000000,
      location_city: "Hyderabad",
      location_state: "Telangana",
      location_country: "India",
      ...
      property_type: "Villa",
      ownerId: user.id,
      amenities: JSON.stringify(["Private Garden", "Servant Quarters", "Gated Community"]),
      images: JSON.stringify(["/properties/scenic_villa.png"]),
    },
    {
      title: "Modern Apartment in Narsingi",
      description: "Newly constructed apartment in Narsingi. Located near the Outer Ring Road for excellent connectivity.",
      price: 8500000,
      location_city: "Hyderabad",
      location_state: "Telangana",
      location_country: "India",
      ...
      property_type: "Apartment",
      ownerId: user.id,
      amenities: JSON.stringify(["Swimming Pool", "Gym", "Supermarket"]),
      images: JSON.stringify(["/properties/modern_apartment.png"]),
    }
  ];
